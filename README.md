...
**هذا التطبيق مخصص للأغراض التعليمية والعرض فقط.**

لا يجب استخدامه لأغراض تجارية أو ضريبية بدون:
- استشارة قانونية متخصصة
- تسجيل رسمي مع ZATCA (هيئة الزكاة والضريبة والجمارك)
- الحصول على موافقات من السلطات المختصة
